...
- Only situational factors from play by play data
...
```{r out.width='33%', echo = FALSE, fig.align='bottom'}
...
```{r out.width='65%', echo = FALSE, fig.align='center'}
knitr::include_graphics("linemense.PNG")
```
...
- Trained model on 2012-2017 FastR Play by Play Situational Data
...
- Situational Factors Only Accuracy: 63.27 %
- Situational Factors Only Brier Score: 0.2085403


- Mixture of Situational Factors and Tracking Data Variables Accuracy: 86.91667 %
- Mixture of Situational Factors and Tracking Data Variables Brier Score: 0.0519

---
## Each Team's Pass Rate Over Expected for 2017 
...
- Began investigating the predictability of each team

--

# Future Work

- Look at how our model does in specific subsets
- Expand our model to update predictions within the first three seconds of the play
